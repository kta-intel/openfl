...
# def flower_to_openfl_message(flower_message, sender, receiver):
...
#         openfl_message.header.sender = sender
#         openfl_message.header.receiver = receiver
...
#         # Set the DataStream message content to the serialized Flower message content
#         openfl_message.message.npbytes = flower_message.grpc_message_content
#         openfl_message.message.size = len(flower_message.grpc_message_content)

#         metadata = dict(flower_message.metadata)
#         for key, value in metadata.items():
#             openfl_message.metadata[key] = value
...
#         # bytes_parsed = flower_message.grpc_message_content = openfl_message.message.npbytes

#         flower_message.grpc_message_content = openfl_message.message.npbytes

#         metadata = dict(openfl_message.metadata)
#         for key, value in metadata.items():
#             flower_message.metadata[key] = value

#         # Will be depracated by Flower #
#         flower_message.grpc_message_name = metadata.get('grpc-message-qualname')
#         ################################
#         return flower_message

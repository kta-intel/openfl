...
class GuacamolDataModule(MolecularDataModule):
    def __init__(self, cfg):
        ...
        self.train_smiles = []
        #TODO: make sure this will load data from the workspace
        datasets = {'train': GuacamolDataset(stage='train', root=self.datadir, filter_dataset=self.filter),
                    'val': GuacamolDataset(stage='val', root=self.datadir, filter_dataset=self.filter),
                    'test': GuacamolDataset(stage='test', root=self.datadir, filter_dataset=self.filter)}

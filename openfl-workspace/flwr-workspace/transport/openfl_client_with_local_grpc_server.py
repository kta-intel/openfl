...
class OpenFLClient:
    ...
    def send_message_to_server(self, flower_message):
        ...
        message_logger.log_message(
            f"metadata: {dict(flower_message.metadata)} "
            f"grpc_message_name: \"{flower_message.grpc_message_name}\" "
            f"grpc_message_content: \"{flower_message.grpc_message_content}\"",
        ...
        message_logger.log_message(
            ...
            f"payload: \"{openfl_message.payload}\" "

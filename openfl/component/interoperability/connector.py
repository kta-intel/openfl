    ...
    def stop(self):
        ...
        for sub_process in sub_processes:
            ...
            try:
                ...
                self.logger.info(f"[OpenFL Connector] Process with PID: {sub_process.pid} already terminated. Moving on.")
                continue
        ...
        for p in still_alive:
            try:
                ...
                self.logger.info(f"[OpenFL Connector] Process with PID: {p.pid} already terminated. Moving on.")
                continue

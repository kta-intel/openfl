...
class Qm9RegressorDiscrete(pl.LightningModule):
    ...
    def on_train_epoch_start(self) -> None:
        self.print("Starting train epoch for regressor...")
    ...
    def validation_step(self, data, i):
        ...
        #print("Val Target is", target)
        #print("Val Pred is", pred.y)
        #print('Val Loss is', mae)
        # self.log('val_loss', mae, prog_bar=True, on_step=False, on_epoch=True)
        self.log_dict({'val loss': mae}, on_epoch=True)
        return {'val_loss': mae}
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        if self.args.general.guidance_target == 'both':
            ...
            for i in range(2):
                ...
                self.print(f"Target {self.target_dict[i]}: val_mae: {mae_each :.3f}")
    ...
    def forward(self, noisy_data, extra_data, node_mask):
        ...
        #print('E', E.shape)
        #print('y', y.shape)
        #print('nodemask', node_mask.shape)
